	                ...
	                <ul class="nav" id="side-menu">
	                    ...
	                    <li>
	                        ...
	                        <ul class="nav nav-second-level">
	                            ...
	                            <li>
	                                <a class="J_menuItem"  href="<?php echo U('GoodType/index');?>" target="iframe">商品类型</a>
	                            </li>
	                            <li>
	                    ...
	                    <li>
	                        ...
	                        <ul class="nav nav-second-level">
	                            ...
	                            <li>
	                                <a class="J_menuItem" href="<?php echo U('Admin/showlog');?>">管理员日志</a>
	                            </li>
	                            <li>
	                                <a class="J_menuItem" href="<?php echo U('User/index');?>">用户管理</a>
	                            </li>
	                        </ul>
	                    </li>
	                    <li>
	                        ...
	                        <ul class="nav nav-second-level">
	                            <li>
	                                <a class="J_menuItem" href="<?php echo U('ads/index');?>">广告列表</a>
	                            </li>
	                            <li>
	                                <a class="J_menuItem" href="<?php echo U('ads/action');?>">广告位</a>
	                            </li>
	                        </ul>
	                    </li>
	                    <li>
	                        ...
	                        <ul class="nav nav-second-level">
	                        	<li>
	                                <a class="J_menuItem" href="<?php echo U('Db/backup');?>">数据表备份</a>
	                            </li>
	                            <li>
	                                <a class="J_menuItem" href="<?php echo U('Db/index');?>">数据表优化</a>
	                            </li>
	                        </ul>
	                    </li>
	                </ul>
	   ...
	   <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1" >
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe" width="100%" height="100%" src="<?php echo U('Index/main');?>" frameborder="0"  seamless></iframe>
			</div>
		     <div class="footer">
