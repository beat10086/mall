	                ...
	                <ul class="nav" id="side-menu">
	                    ...
	                    <li>
	                        ...
	                        <ul class="nav nav-second-level">
	                            ...
	                            <li>
	                                <a class="J_menuItem" href="<?php echo U('GoodType/index');?>">商品类型</a>
	                            </li>
	                            <li>
	   ...
	   <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1" >
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo U('Index/main');?>" frameborder="0"  seamless></iframe>
			</div>
		     <div class="footer">
